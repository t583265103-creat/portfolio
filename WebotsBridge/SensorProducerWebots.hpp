...
private:
    ...
    // Track last time we actually processed a camera frame to avoid using
    // frames captured before the device sampling period elapses.
    ...
    static constexpr double BASE_LAT = 32.75530185851649;   // רכסים — נקודת התחלה
