...
A full autonomous navigation system for a wheelchair robot, built in C++ and simulated in **Webots**. The system runs a closed control loop at **100Hz**, integrating 6 sensor types, real-time 3D mapping, multi-object tracking, and two-tier path planning.
