...
// ─────────────────────────────────────────────────────────────────────────────
//  עזר: מרחק בין EKF לצומת גלובלי [מ']
// ─────────────────────────────────────────────────────────────────────────────
...
// ─────────────────────────────────────────────────────────────────────────────
//  sendDriveCommand()
//  TODO: חברי לנהג המנוע האמיתי שלך
//  linear_speed  [מ"ש]  — חיובי = קדימה
//  angular_speed [ראד/ש] — חיובי = שמאלה
// ─────────────────────────────────────────────────────────────────────────────
                                            ...
                                            MapData&         mapData)
{
    ...
    float linear;
    float angular_max;
    // angular_max לכל range מחושב כך ש-leftVel = linear*INV_R - angular*WB_OVER_2R >= 0.
    // אין spin-in-place — גם בשגיאה גדולה הרובוט זוחל קדימה בקשת.
    ...
    // safety clamp: אם linear>0 ו-angular גורם לגלגל שמאל ללכת אחורה — מקטין angular
    if (linear > 0.0f) {
...
// ─────────────────────────────────────────────────────────────────────────────
//  stopEkf() — מאפס מהירויות ב-EKF דרך תור העדכון
// ─────────────────────────────────────────────────────────────────────────────
//צריך לעשות פקודת האטה
