...
#include "MapLive/OctomapAdapter.hpp"  // ← חייב להיות לפני השימוש ב-m_octomap
    ...
    float& x0, float& y0, float& x1, float& y1, float& halfWidth) const
{
    ...
    // אותה לוגיקה כמו MapLocal::buildRouteLimitLayer (DEFAULT/MIN/MAX_CORRIDOR_WIDTH_M)
    ...
    const MapData& mapData)
{
    ...
    // ברירת מחדל: התא האחרון בנתיב (אם כולם קרובים מהמרחק המבוקש)
